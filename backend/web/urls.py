...
urlpatterns = [
    ...
    path("shortterm/", views.shortterm_lodges, name="shortterm-lodges"),
    path("shortterm/lodges/", views.shortterm_lodges, name="shortterm-lodges-alt"),
    ...
    path("map/", views.map_view, name="web-map"),
